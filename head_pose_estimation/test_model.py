#reference : https://github.com/arnaldog12/Deep-Learning/tree/master/problems/Regressor-Face%20Pose
...
from sklearn.preprocessing import StandardScaleur

x, y = pkl.load(open('./model/samples.pkl', 'rb'))
...
im = cv2.imread('/Users/hong-yujin/Desktop/빅데이터 청년인재/팀프로젝트/yujin_focus/lec3/HYJ_lec3_frame2.jpg', cv2.IMREAD_COLOR) #need to change
